...
export default function SearchBar() {
    ...
    const handleSearchSubmit = (e) => {
        e.preventDefault();
        console.log('Search query:', searchQuery); // Aquí puedes manejar la búsqueda
        setModalOpened(false); // Cierra el modal después de enviar el formulario
    };
    ...
    return (
        <div>
            ...
            {/* Modal */}
            <Modal show={modalOpened} onClose={() => setModalOpened(false)} maxWidth="2xl">
                <form className="max-w-md mx-auto" onSubmit={handleSearchSubmit}>
                    <label htmlFor="modal-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">
                        Search
                    </label>
                    <div className="relative">
                        <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
